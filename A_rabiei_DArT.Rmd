...
# Experimental Design
DNA was extracted from 279 isolates of Australian _Ascochyta rabiei_ and 2 Spanish _A. rabiei_ isolates and sent for DArT-Sequencing at Diversity Array Technologies (DArT, Canberra) on a single flowcell an Illumina NovaSeq, producing 150 bp short paired-end reads (run name CAGRF20074).  
